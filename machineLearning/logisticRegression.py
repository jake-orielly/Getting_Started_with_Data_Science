...
from multipleRegression import predict, estimate_beta
import random, math
...
def train_test_split(x, y, test_pct):
    ...
    x_train, y_train = zip(*train)                # un-zip
...
predictions = [logistic(fnc.dot(beta_hat, x_i)) for x_i in x_test]
